  ...
  <?php
   ...
   <form action="#" method="post">
     ...
     <div class="form-group col-md-6">
       ...
       <input type="password" id="confirm_password" name="confirm_password" placeholder="Confime a Senha" class="form-control <?= $errors['confirm_password'] ? 'is-invalid' : '' ?>">
       <div class="invalid-feedback">
   ...
   <div class="form-group col-md-6">
     ...
     <input type="date" id="start_date" name="start_date" class="form-control <?= $errors['start_date'] ? 'is-invalid' : '' ?>" value="<?= $startDate ?>">
     <div class="invalid-feedback">
       <?= $errors['start_date'] ?>
     </div>
    </div>
     <div class="form-group col-md-6">
       ...
       <input type="date" id="end_date" name="end_date" class="form-control <?= $errors['end_date'] ? 'is-invalid' : '' ?>" value="<?= $endDate ?>">
        <div class="invalid-feedback">
          <?= $errors['end_date'] ?>
       </div>
      </div>
